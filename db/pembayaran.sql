...
(2,	2111111111111111,	2111111111111112,	'Silvani Violita',	'Perempuan',	2,	'Ahmad',	'Zurriati',	'Pati'),
(4,	1111111111111111,	1111111111111113,	'Elga Yuan Saputra',	'Laki-laki',	1,	'Syafruddin',	'Aminah',	'Lampung'),
(5,	1111111111111114,	1111111111111113,	'Admad Syukron',	'Laki-laki',	1,	'Syafruddin',	'Aminah',	'Demak'),
(6,	1111111111111115,	1111111111111113,	'Putri Yulia Sari',	'Perempuan',	5,	'',	'Aminah',	'Pati');
...
(7,	'Moh Saifuddin',	'saifuddin@gmail.com',	'profile_user.jpg',	'$2y$10$UKKPcRTGe9euoWPRVHd1EOG0NCvKxWuqaYU1nW6MNO5cJh8lVPhAO',	1,	1,	1571583076),
(8,	'Yudha Kurniawan',	'admin@admin.com',	'avatar_admin1.png',	'$2y$10$3J01pcyXlw.8qJhTP0HYBOnxVdfRTtj/xFm8YPqDxAM2L0QsPVBAu',	1,	1,	1576980466);
